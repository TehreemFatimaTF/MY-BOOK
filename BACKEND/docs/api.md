# Book RAG Chatbot API Documentation

## Overview
The Book RAG Chatbot API provides endpoints for uploading books, querying book content, and managing conversation history. The API uses standard REST conventions with JSON requests and responses.
...
## Rate Limiting
The API implements rate limiting to ensure fair usage. Each API key is limited to 100 requests per hour.
